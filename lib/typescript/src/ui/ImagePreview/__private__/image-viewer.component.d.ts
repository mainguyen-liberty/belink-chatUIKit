...
import { IImageInfo, ImageViewerProps, ImageViewerState } from './image-viewer.type';
export declare class ImageViewer extends React.Component<ImageViewerProps, ImageViewerState> {
    ...
    static getDerivedStateFromProps(nextProps: ImageViewerProps, prevState: ImageViewerState): {
        currentShowIndex: number | undefined;
        prevIndexProp: number | undefined;
    } | null;
    componentDidUpdate(prevProps: ImageViewerProps, _prevState: ImageViewerState): void;
    /**
     * props 有变化时执行
     */
    init(nextProps: ImageViewerProps): void;
    /**
