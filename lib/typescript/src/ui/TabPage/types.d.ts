...
export declare function TabPageBodyItem(props: TabPageBodyItemProps): JSX.Element;
export type TabPageBodyRef = {
    scrollTo: (index: number, animated?: boolean) => void;
};
export type TabPageBodyProps = Omit<ScrollViewProps, 'pagingEnabled' | 'showsHorizontalScrollIndicator' | 'bounces' | 'horizontal' | 'children'> & {
...
export type TabPageBodyTProps<BodyProps extends {} = {}> = Omit<ScrollViewProps, 'pagingEnabled' | 'showsHorizontalScrollIndicator' | 'bounces' | 'horizontal' | 'children'> & {
...
export type TabPageBodyLISTProps<BodyProps extends {} = {}> = Omit<ScrollViewProps, 'pagingEnabled' | 'showsHorizontalScrollIndicator' | 'bounces' | 'horizontal' | 'children'> & {
