 ...
 * The font styles
 */
export type FontStyles = Pick<TextStyle, 'fontFamily' | 'fontSize' | 'fontWeight' | 'lineHeight'>;
/**
 * The icon styles
 */
...
export type ColorLineGradientPalette = {
    topToBottom: LineGradientPoint;
    bottomToTop: LineGradientPoint;
    leftToRight: LineGradientPoint;
    rightToLeft: LineGradientPoint;
    leftTopToRightBottom: LineGradientPoint;
    rightTopToLeftBottom: LineGradientPoint;
    rightBottomToLeftTop: LineGradientPoint;
    leftBottomToRightTop: LineGradientPoint;
};
 ...
 * The button size.
 */
export type ButtonSize = Pick<ViewStyle, 'borderWidth' | 'borderRadius' | 'height' | 'minWidth' | 'maxWidth' | 'paddingHorizontal' | 'paddingVertical' | 'width'>;
