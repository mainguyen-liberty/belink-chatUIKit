...
import type { BottomSheetNameMenuRef, InitMenuItemsType } from './BottomSheetMenu';
export type PropsWithTest = {
    testMode?: 'only-ui' | undefined;
};
export type PropsWithError = {
    onError?: (error: UIKitError) => void;
};
...
export type PropsWithFlatList<ListItemProps> = {
     ...
     */
    flatListProps?: Omit<FlatListProps<ListItemProps>, 'ref' | 'data' | 'renderItem'>;
};
/**
 * Common properties.
 */
export type PropsWithSectionList<ListItemProps, SectionT extends DefaultSectionT = DefaultSectionT> = {
    /**
     * Properties of the list component. Currently, direct setting of ref, data, renderItem is not supported.
     */
    sectionListProps?: Omit<SectionListProps<ListItemProps, SectionT>, 'ref' | 'data' | 'renderItem'>;
};
/**
 * Common properties.
 */
 ...
 */
export type ContactType = 'contact-list' | 'new-conversation' | 'create-group' | 'add-group-member' | 'share-contact';
/**
 ...
 */
export type GroupParticipantType = 'common' | 'delete' | 'change-owner' | 'mention';
/**
 ...
 */
export type SearchType = 'conv-list' | 'contact-list' | 'new-conversation' | 'create-group' | 'add-group-member' | 'share-contact' | 'group-list' | 'group-member-list' | 'request-list';
/**
 * List item type. Mainly include: conversation list, contact list, group list, group member list.
 */
export type ListItemType = 'conv-list' | 'contact-list' | 'group-list' | 'group-member-list';
/**
 ...
 */
export type UseSectionListReturn<ItemT, SectionT extends DefaultSectionT, ListIndexPropsT extends DefaultListIndexPropsT> = UseListBasicReturn<ItemT> & {
    /**
     * @description The data source of the list.
     */
 ...
 */
export type FlatListRefType<DataModel, ListItemProps> = BasicListRefType<DataModel> & {
    /**
 ...
 */
export type SectionListRefType<DataModel, ListItemProps, SectionT extends DefaultSectionT = DefaultSectionT> = BasicListRefType<DataModel> & {
    /**
     * Get the section list component reference.
     */
    getSectionListRef: () => React.RefObject<SectionListRef<ListItemProps, SectionT>>;
};
