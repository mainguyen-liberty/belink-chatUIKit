...
import type { ContactType, ListActions, ListItemActions, ListItemProps, ListItemRequestProps, ListRequestProps, ListStateType, PropsWithBack, PropsWithCancel, PropsWithError, PropsWithInit, PropsWithMenu, PropsWithNavigationBar, PropsWithSearch, PropsWithSectionList, PropsWithTest, SearchType, SectionListRefType } from '../types';
export type ContactListItemComponentType = React.ComponentType<ContactListItemProps> | React.ExoticComponent<ContactListItemProps>;
export type ContactListItemHeaderComponentType = React.ComponentType<SectionListData<ContactListItemProps, IndexModel>> | React.ExoticComponent<SectionListData<ContactListItemProps, IndexModel>>;
/**
 ...
 * Contact list item component properties.
 */
export type ContactListItemProps = ListItemProps & ListItemRequestProps<DataModel> & Omit<ListItemActions<ContactModel>, 'onToRightSlide' | 'onToLeftSlide'> & {
    /**
     * Contact data model.
     */
 ...
 */
export type ContactListRef = Omit<SectionListRefType<ContactModel, ContactListItemProps, IndexModel>, 'updateItem' | 'clearItem'> & {
    /**
 ...
 */
export type ContactListNavigationBarProps = PropsWithNavigationBar & PropsWithBack & {
    /**
     * Contact type.
     */
    contactType: ContactType;
 ...
 */
export type ContactListProps = Pick<ListRequestProps<DataModel>, 'onRequestMultiData'> & PropsWithTest & PropsWithInit & PropsWithBack & PropsWithSearch & ContactListNavigationBarProps & PropsWithSectionList<ContactListItemProps, IndexModel> & PropsWithMenu & Omit<ListActions<ContactModel>, 'onToRightSlideItem' | 'onToLeftSlideItem'> & {
    /**
     ...
     */
    onInitListItemActions?: (defaultItems: React.ReactElement<ContactItemProps>[]) => React.ReactElement<ContactItemProps>[];
    /**
     ...
     */
    onSort?: (prevProps: ContactListItemProps, nextProps: ContactListItemProps) => number;
    /**
 ...
 */
export type SearchContactProps = ListRequestProps<DataModel> & PropsWithTest & PropsWithError & PropsWithCancel & Omit<ListItemActions<ContactModel>, 'onToRightSlide' | 'onToLeftSlide' | 'onLongPressed'> & {
    /**
     * Component style properties.
     */
    containerStyle?: StyleProp<ViewStyle>;
...
export type ContactSearchModel = ContactModel & DataModel & {
    /**
