...
import type { DataModel, GroupParticipantModel, ResultCallback } from '../../chat';
import type { DefaultComponentModel } from '../ListSearch';
import type { GroupParticipantType, ListActions, ListItemActions, ListItemProps, ListItemRequestProps, ListRequestProps, PropsWithBack, PropsWithError, PropsWithInit, PropsWithNavigationBar, PropsWithSearch, PropsWithTest } from '../types';
/**
 ...
 */
export type GroupParticipantListNavigationBarProps = PropsWithBack & PropsWithNavigationBar & {
    /**
 ...
 */
export type GroupParticipantListProps = Pick<ListRequestProps<DataModel>, 'onRequestGroupData'> & PropsWithTest & PropsWithError & PropsWithInit & PropsWithSearch & GroupParticipantListNavigationBarProps & Omit<ListActions<GroupParticipantModel>, 'onToRightSlideItem' | 'onToLeftSlideItem'> & {
    /**
     * Group ID.
     */
    groupId: string;
 ...
 */
export type GroupParticipantListItemProps = ListItemProps & ListItemRequestProps<DataModel> & Omit<ListItemActions<GroupParticipantModel>, 'onToRightSlide' | 'onToLeftSlide'> & {
 ...
 */
export type GroupParticipantListItemComponentType = React.ComponentType<GroupParticipantListItemProps> | React.ExoticComponent<GroupParticipantListItemProps>;
/**
 * Search group member component properties.
 */
export type SearchGroupParticipantProps = PropsWithTest & PropsWithError & Omit<ListItemActions<GroupParticipantModel>, 'onToRightSlide' | 'onToLeftSlide'> & {
    groupId: string;
    containerStyle?: StyleProp<ViewStyle>;
    onCancel?: () => void;
};
 ...
 */
export type SelectSingleParticipantProps = Pick<GroupParticipantListProps, 'groupId' | 'containerStyle' | 'onBack' | 'onClickedItem' | 'onError' | 'testMode'> & {
    onSelectResult?: ResultCallback<GroupParticipantModel>;
};
export type GroupParticipantSearchModel = GroupParticipantModel & DefaultComponentModel;
