...
import type { FlatListRefType, ListActions, ListItemActions, ListItemProps, ListItemRequestProps, ListStateType, PropsWithBack, PropsWithCancel, PropsWithFlatList, PropsWithInit, PropsWithMenu, PropsWithNavigationBar, PropsWithSearch, PropsWithTest } from '../types';
/**
 * Group List Item Component.
 */
export type GroupListItemProps = ListItemProps & ListItemRequestProps<DataModel> & Omit<ListItemActions<GroupModel>, 'onToRightSlide' | 'onToLeftSlide'> & {
    data: GroupModel;
};
export type GroupListItemComponentType = React.ComponentType<GroupListItemProps> | React.ExoticComponent<GroupListItemProps>;
/**
 * Group List Component reference.
 */
export type GroupListRef = Omit<FlatListRefType<GroupModel, GroupListItemProps>, 'addItem' | 'clearItem' | 'updateItem' | 'showMenu' | 'closeMenu'> & {
    /**
 ...
 */
export type GroupListProps = PropsWithTest & PropsWithInit & PropsWithBack & PropsWithSearch & PropsWithNavigationBar & PropsWithFlatList<GroupListItemProps> & PropsWithMenu & Omit<ListActions<GroupModel>, 'onToRightSlideItem' | 'onToLeftSlideItem'> & {
    /**
 ...
 */
export type SearchGroupProps = PropsWithTest & PropsWithCancel & Omit<ListItemActions<GroupModel>, 'onToRightSlide' | 'onToLeftSlide' | 'onLongPressed'> & {
    containerStyle?: StyleProp<ViewStyle>;
};
