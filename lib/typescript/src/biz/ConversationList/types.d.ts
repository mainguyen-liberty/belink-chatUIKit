...
import type { FlatListRefType, ListActions, ListItemActions, ListItemProps, ListItemRequestProps, ListRequestProps, ListStateType, PropsWithBack, PropsWithCancel, PropsWithFlatList, PropsWithInit, PropsWithMenu, PropsWithNavigationBar, PropsWithSearch, PropsWithTest } from '../types';
/**
 * Conversation list item component properties.
 */
export type ConversationListItemProps = ListItemProps & ListItemRequestProps<DataModel> & Omit<ListItemActions<ConversationModel>, 'onToRightSlide' | 'onToLeftSlide'> & {
    data: ConversationModel;
};
export type ConversationListItemComponentType = React.ComponentType<ConversationListItemProps> | React.ExoticComponent<ConversationListItemProps>;
/**
 * Conversation list component reference.
 */
export type ConversationListRef = Omit<FlatListRefType<ConversationModel, ConversationListItemProps>, 'clearItem' | 'updateItem'> & {
    /**
 ...
 */
export type ConversationListProps = Pick<ListRequestProps<DataModel>, 'onRequestMultiData'> & PropsWithTest & PropsWithInit & PropsWithBack & PropsWithSearch & PropsWithNavigationBar & PropsWithFlatList<ConversationListItemProps> & PropsWithMenu & Omit<ListActions<ConversationModel>, 'onToRightSlideItem' | 'onToLeftSlideItem'> & {
    /**
     ...
     * @returns -1, 0, 1
     */
    onSort?: (prevProps: ConversationListItemProps, nextProps: ConversationListItemProps) => number;
    /**
     ...
     */
    onInitNavigationBarMenu?: (initItems: InitMenuItemsType[]) => InitMenuItemsType[];
    /**
 ...
 */
export type SearchConversationProps = PropsWithTest & PropsWithCancel & Omit<ListItemActions<ConversationModel>, 'onToRightSlide' | 'onToLeftSlide' | 'onLongPressed'> & {
    containerStyle?: StyleProp<ViewStyle>;
    /**
     * filter empty conversation.
     */
