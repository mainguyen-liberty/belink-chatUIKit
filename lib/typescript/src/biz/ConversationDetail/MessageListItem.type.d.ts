...
import type { MessageLayoutType, MessageListItemActionsProps, MessageListItemRenders, MessageModel, MessageStateType, SystemMessageModel, TimeMessageModel } from './types';
/**
 ...
 */
export type MessageBubbleProps = MessageListItemRenders & MessageListItemActionsProps & {
    hasTriangle?: boolean;
    model: MessageModel;
    containerStyle?: StyleProp<ViewStyle>;
    maxWidth?: number;
 ...
 */
export type MessageViewProps = MessageListItemRenders & MessageListItemActionsProps & {
    isVisible?: boolean;
    model: MessageModel;
...
//# sourceMappingURL=MessageListItem.type.d.ts.map