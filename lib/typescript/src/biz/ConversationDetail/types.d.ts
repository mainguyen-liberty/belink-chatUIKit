...
import type { PropsWithBack, PropsWithError, PropsWithSearch, PropsWithTest } from '../types';
import type { MessageBubbleRender, MessageContentRender, MessageQuoteBubbleRender, MessageViewRender, SystemTipViewRender, TimeTipViewRender } from './MessageListItem.type';
/**
 ...
 */
export type MessageInputProps = PropsWithError & PropsWithTest & {
    /**
     * Conversation ID.
     */
    convId: string;
     ...
     */
    onClickedSend?: (value: SendTextProps | SendFileProps | SendImageProps | SendVideoProps | SendVoiceProps | SendCardProps) => void;
    /**
 ...
 */
export type ConversationDetailProps = PropsWithError & PropsWithTest & PropsWithBack & PropsWithSearch & {
    /**
     * Conversation ID.
     */
    convId: string;
    ...
    input?: {
         ...
         * The input component.
         */
        render?: React.ForwardRefExoticComponent<MessageInputProps & React.RefAttributes<MessageInputRef>>;
        /**
    ...
    list?: {
         ...
         */
        render?: React.ForwardRefExoticComponent<MessageListProps & React.RefAttributes<MessageListRef>>;
        /**
 ...
 */
export type SendType = 'text' | 'file' | 'image' | 'voice' | 'video' | 'time' | 'system' | 'card' | 'custom';
/**
 ...
 */
export type SendImageProps = SendBasicProps & SendFileProps & {
    imageWidth: number;
    imageHeight: number;
};
/**
 ...
 */
export type SendVoiceProps = SendBasicProps & SendFileProps & {
    duration: number;
};
/**
 * Message input component send video message properties.
 */
export type SendVideoProps = SendBasicProps & SendFileProps & {
 ...
 */
export type MessageSendStateType = 'sending' | 'send-success' | 'send-fail' | 'send-to-peer' | 'peer-read';
/**
 * Message state type.
 */
export type MessageStateType = MessageRecvStateType | MessageSendStateType | 'none';
/**
 ...
 */
export type MessageModel = BasicModel & VoiceModel & {
...
export type MessageListItemActionsProps = {
     ...
     */
    onClicked?: (id: string, model: SystemMessageModel | TimeMessageModel | MessageModel) => void;
    /**
     * Callback notification when a list item is long pressed.
     * @param id Message ID or timestamp.
     * @param model Message model. See detail {@link MessageModel} {@link TimeMessageModel} {@link MessageModel}.
     */
    onLongPress?: (id: string, model: SystemMessageModel | TimeMessageModel | MessageModel) => void;
    /**
     * Callback notification when the avatar of a list item is clicked.
     * @param id Message ID or timestamp.
     * @param model Message model. See detail {@link MessageModel} {@link TimeMessageModel} {@link MessageModel}.
     */
    onAvatarClicked?: (id: string, model: SystemMessageModel | TimeMessageModel | MessageModel) => void;
    /**
     * Callback notification when the quote of a list item is clicked.
     * @param id Message ID or timestamp.
     * @param model Message model. See detail {@link MessageModel} {@link TimeMessageModel} {@link MessageModel}.
     */
    onQuoteClicked?: (id: string, model: SystemMessageModel | TimeMessageModel | MessageModel) => void;
    /**
     * Callback notification when the state of a list item is clicked.
     * @param id Message ID or timestamp.
     * @param model Message model. See detail {@link MessageModel} {@link TimeMessageModel} {@link MessageModel}.
     */
    onStateClicked?: (id: string, model: SystemMessageModel | TimeMessageModel | MessageModel) => void;
};
/**
 ...
 */
export type MessageListItemProps = MessageListItemRenders & MessageListItemActionsProps & {
    /**
 ...
 */
export type MessageListItemComponentType = React.ComponentType<MessageListItemProps> | React.ExoticComponent<MessageListItemProps>;
/**
...
export type MessageListRef = {
     ...
     */
    addSendMessage: (value: SendFileProps | SendImageProps | SendTextProps | SendVideoProps | SendVoiceProps | SendTimeProps | SendSystemProps | SendCardProps | SendCustomProps) => void;
    /**
 ...
 */
export type MessageListProps = PropsWithError & PropsWithTest & {
    /**
     * Conversation ID.
     */
    convId: string;
     ...
     */
    onClickedItem?: (id: string, model: SystemMessageModel | TimeMessageModel | MessageModel) => void | boolean | undefined;
    /**
     * Callback notification when a list item is long pressed.
     *
     * If the return result is false, the default behavior is prevented.
     */
    onLongPressItem?: (id: string, model: SystemMessageModel | TimeMessageModel | MessageModel) => void | boolean | undefined;
    /**
     * Callback notification when the avatar of a list item is clicked.
     *
     * If the return result is false, the default behavior is prevented.
     */
    onClickedItemAvatar?: (id: string, model: SystemMessageModel | TimeMessageModel | MessageModel) => void | boolean | undefined;
    /**
     * Callback notification when the quote of a list item is clicked.
     *
     * If the return result is false, the default behavior is prevented.
     */
    onClickedItemQuote?: (id: string, model: SystemMessageModel | TimeMessageModel | MessageModel) => void | boolean | undefined;
    /**
