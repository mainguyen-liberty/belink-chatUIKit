import type { ChatClient, ChatContactEventListener, ChatConversationType, ChatCustomEventListener, ChatGroupEventListener, ChatMessage, ChatMessageEventListener, ChatMessageStatusCallback, ChatMultiDeviceEventListener, ChatOptions, ChatPresenceEventListener, ChatSearchDirection } from 'react-native-chat-sdk';
...
import type { ContactModel, ConversationModel, GroupModel, GroupParticipantModel, StateModel, UIListener, UIListenerType } from './types.ui';
/**
 ...
 */
export declare enum DisconnectReasonType {
 ...
 */
export type MessageServiceListener = PartialUndefinable<ChatMessageEventListener>;
/**
 ...
 */
export type GroupServiceListener = PartialUndefinable<ChatGroupEventListener> & {};
/**
 * The type of contact listener.
 */
export type ContactServiceListener = PartialUndefinable<ChatContactEventListener>;
/**
 * The type of presence listener.
 */
export type PresenceServiceListener = PartialUndefinable<ChatPresenceEventListener>;
/**
 ...
 */
export type MultiDeviceStateListener = PartialUndefinable<ChatMultiDeviceEventListener>;
/**
 ...
 * ```
 */
export type ChatServiceListener = ConnectServiceListener & MessageServiceListener & ConversationListener & GroupServiceListener & ContactServiceListener & PresenceServiceListener & CustomServiceListener & MultiDeviceStateListener & EventServiceListener;
/**
 ...
 */
export interface ChatService extends ConversationServices, ContactServices, GroupServices, UserServices, MessageServices, PresenceServices {
    /**
     * Add listener.
