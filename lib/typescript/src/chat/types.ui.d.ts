import type { ChatContact, ChatConversation, ChatConversationType, ChatGroup, ChatMessage } from 'react-native-chat-sdk';
import type { PartialUndefinable } from '../types';
export declare enum UIListenerType {
 ...
 */
export type ConversationModel = Pick<_ConversationModel, 'ext' | 'isPinned' | 'pinnedTime'> & {
    /**
     * The conversation ID.
     */
    convId: string;
 ...
 */
export type ContactModel = _ContactModel & StateModel & {
    userId: string;
    userName?: string;
    userAvatar?: string;
};
type _GroupModel = Omit<PartialUndefinable<ChatGroup>, 'memberList' | 'adminList' | 'blockList' | 'muteList'>;
/**
...
export {};
//# sourceMappingURL=types.ui.d.ts.map