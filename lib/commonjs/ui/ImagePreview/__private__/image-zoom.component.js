...
var _imageZoom = _interopRequireDefault(require("./image-zoom.style"));
var _imageZoom2 = require("./image-zoom.type");
...
function _extends() { _extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); } // ref: https://github.com/ascoders/react-native-image-zoom/blob/master/src/image-zoom/image-zoom.component.tsx
class ImageZoom extends React.Component {
  static defaultProps = new _imageZoom2.ImageZoomProps();
  state = new _imageZoom2.ImageZoomState();

  // 上次/当前/动画 x 位移
  lastPositionX = null;
  positionX = 0;
  animatedPositionX = new _reactNative.Animated.Value(0);

  // 上次/当前/动画 y 位移
  lastPositionY = null;
  positionY = 0;
  animatedPositionY = new _reactNative.Animated.Value(0);

  // 缩放大小
  scale = 1;
  animatedScale = new _reactNative.Animated.Value(1);
  ...
  // 图片手势处理
  imagePanResponder = _reactNative.PanResponder.create({
    // 要求成为响应者：
      ...
      if (evt.nativeEvent.changedTouches.length <= 1) {
        ...
        if (new Date().getTime() - this.lastClickTime < (this.props.doubleClickInterval || 0)) {
          ...
          if (this.props.enableDoubleClickZoom) {
            ...
            _reactNative.Animated.parallel([_reactNative.Animated.timing(this.animatedScale, {
              toValue: this.scale,
              duration: 100,
  ...
  render() {
    ...
    const parentStyles = _reactNative.StyleSheet.flatten(this.props.style);
    return /*#__PURE__*/React.createElement(_reactNative.View, _extends({
      style: {
        ..._imageZoom.default.container,
        ...parentStyles,
        width: this.props.cropWidth,
        height: this.props.cropHeight
      }
    }, this.imagePanResponder.panHandlers), /*#__PURE__*/React.createElement(_reactNative.Animated.View, {
      style: animateConf,
