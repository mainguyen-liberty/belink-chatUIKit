...
exports.useGroupParticipantList = useGroupParticipantList;
var React = _interopRequireWildcard(require("react"));
var _chat = require("../../chat");
var _i18n = require("../../i18n");
var _useCloseMenu = require("../hooks/useCloseMenu");
var _List = require("../List");
var _GroupParticipantList = require("./GroupParticipantList.item");
...
function useGroupParticipantList(props) {
  const {
    onClickedItem,
    onLongPressedItem,
    testMode,
  ...
  const ListItemRenderRef = React.useRef(propsListItemRender ?? _GroupParticipantList.GroupParticipantListItemMemo);
  ...
  (0, _chat.useChatListener)(chatListenerRef.current);
  React.useEffect(() => {
    const uiListener = {
      ...
      type: _chat.UIListenerType.GroupParticipant
    };
