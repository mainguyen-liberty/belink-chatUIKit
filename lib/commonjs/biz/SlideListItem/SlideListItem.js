...
exports.SlideListItem = SlideListItem;
var React = _interopRequireWildcard(require("react"));
var _reactNative = require("react-native");
var _utils = require("../../utils");
var _SlideListItem = require("./SlideListItem.const");
...
function SlideListItem(props) {
  ...
  const _onClicked = () => {
    ...
    endTime.current = (0, _utils.getCurTs)();
  ...
  return /*#__PURE__*/React.createElement(_reactNative.View, {
    ...
    onTouchStart: event => {
      ...
      startTime.current = (0, _utils.getCurTs)();
    },
    onTouchEnd: event => {
      if (event.nativeEvent.locationX < currentX.current + _SlideListItem.gJitterValue && event.nativeEvent.locationX > currentX.current - _SlideListItem.gJitterValue && event.nativeEvent.locationY < currentY.current + _SlideListItem.gJitterValue && event.nativeEvent.locationY > currentY.current - _SlideListItem.gJitterValue) {
        _onClicked();
      }
    },
    bounces: bounces,
