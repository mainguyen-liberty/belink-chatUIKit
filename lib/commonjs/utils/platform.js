...
class LocalPath {
  ...
  static encode(localPath) {
    // !!! maybe file://
    // !!! maybe content://
    if (localPath.startsWith('file://') === false && localPath.startsWith('content://') === false && localPath.startsWith('http://') === false && localPath.startsWith('https://') === false) {
  ...
  static addFileHeader(localPath) {
    // !!! maybe file://
    // !!! maybe content://
    if (localPath.startsWith('file://') === false && localPath.startsWith('content://') === false && localPath.startsWith('http://') === false && localPath.startsWith('https://') === false) {
  ...
  static removeFileHeader(localPath) {
    // !!! maybe file://
    // !!! maybe content://
  ...
  static sendFile(localPath) {
    return LocalPath.decode(localPath);
  }
  static sendImage(localPath) {
    return LocalPath.decode(localPath);
  }
  static sendVideo(localPath) {
    return LocalPath.decode(localPath);
  }
  static sendVoice(localPath) {
    return LocalPath.decode(localPath);
  }
