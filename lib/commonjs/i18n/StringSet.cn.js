...
exports.createStringSetCn = createStringSetCn;
function createStringSetCn() {
  return {
    ...
    '_uikit_group_alert_del_member_title': names => `确认删除${names}等选中成员？`,
    ...
    '_uikit_msg_tip_recall': (isSelf, name) => isSelf === true ? `你撤回了一条消息` : `${name}撤回了一条消息`,
    ...
    '_uikit_info_alert_content_delete_contact': name => `确认删除${name}，同时删除与该联系人的聊天记录`,
    ...
    '_uikit_info_alert_quit_group_content': '确认退出群组，同时删除该群组的聊天记录',
    '_uikit_info_alert_destroy_group_title': '确认解散群聊？',
    '_uikit_info_alert_destroy_group_content': '确认解散群组，同时删除该群组的聊天记录',
...
//# sourceMappingURL=StringSet.cn.js.map