...
exports.createStringSetEn = createStringSetEn;
function createStringSetEn() {
  return {
    'this is test.': 'this is test.',
    'This is test with ${0} and ${1}': (a, b) => {
    ...
    '_uikit_group_alert_change_owner_title': name => `Transfer Group Ownership to ${name}`,
    '_uikit_group_alert_del_member_title': names => `Confirm removal of selected members ${names}?`,
    ...
    '_uikit_msg_tip_recall': (isSelf, name) => isSelf === true ? `You recalled a message` : `${name} recalled a message`,
    ...
    '_uikit_info_alert_content_delete_contact': name => `Confirm deletion of ${name} and all chat history with this contact`,
    ...
    '_uikit_info_alert_quit_group_content': 'Confirm leaving group and deleting group chat history',
    '_uikit_info_alert_destroy_group_title': 'Confirm disbanding group chat?',
    '_uikit_info_alert_destroy_group_content': 'Confirm disbanding group and deleting group chat history',
