...
exports.PermissionServiceImplement = void 0;
var _reactNative = require("react-native");
class PermissionServiceImplement {
  constructor(option) {
    this.option = option;
  }
  ...
  async location(check) {
    const s = this.option.permissions;
    const locationPermissions = _reactNative.Platform.select({
...
exports.PermissionServiceImplement = PermissionServiceImplement;
