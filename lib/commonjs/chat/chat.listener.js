...
exports.ChatServiceListenerImpl = void 0;
var _reactNativeChatSdk = require("react-native-chat-sdk");
var _types = require("./types");
var _types2 = require("./types.ui");
...
let gExceptListener;
class ChatServiceListenerImpl {
  constructor() {
    this._listeners = new Set();
    this._uiListeners = new Map([[_types2.UIListenerType.Conversation, new Set()], [_types2.UIListenerType.Contact, new Set()], [_types2.UIListenerType.Group, new Set()], [_types2.UIListenerType.GroupParticipant, new Set()], [_types2.UIListenerType.NewRequest, new Set()]]);
  }
  get client() {
    return _reactNativeChatSdk.ChatClient.getInstance();
  }
  get listeners() {
  ...
  onDisconnected() {
    this._listeners.forEach(v => {
      ...
      (_v$onDisconnected = v.onDisconnected) === null || _v$onDisconnected === void 0 ? void 0 : _v$onDisconnected.call(v, _types.DisconnectReasonType.others);
    });
  }
  onTokenWillExpire() {
    this._listeners.forEach(v => {
      var _v$onDisconnected2;
      (_v$onDisconnected2 = v.onDisconnected) === null || _v$onDisconnected2 === void 0 ? void 0 : _v$onDisconnected2.call(v, _types.DisconnectReasonType.token_will_expire);
    });
  }
  onTokenDidExpire() {
    this._listeners.forEach(v => {
      var _v$onDisconnected3;
      (_v$onDisconnected3 = v.onDisconnected) === null || _v$onDisconnected3 === void 0 ? void 0 : _v$onDisconnected3.call(v, _types.DisconnectReasonType.token_did_expire);
    });
  }
  onAppActiveNumberReachLimit() {
    this._listeners.forEach(v => {
      var _v$onDisconnected4;
      (_v$onDisconnected4 = v.onDisconnected) === null || _v$onDisconnected4 === void 0 ? void 0 : _v$onDisconnected4.call(v, _types.DisconnectReasonType.app_active_number_reach_limit);
    });
  }
  onUserDidLoginFromOtherDevice() {
    this._listeners.forEach(v => {
      var _v$onDisconnected5;
      (_v$onDisconnected5 = v.onDisconnected) === null || _v$onDisconnected5 === void 0 ? void 0 : _v$onDisconnected5.call(v, _types.DisconnectReasonType.user_did_login_from_other_device);
    });
  }
  onUserDidRemoveFromServer() {
    this._listeners.forEach(v => {
      var _v$onDisconnected6;
      (_v$onDisconnected6 = v.onDisconnected) === null || _v$onDisconnected6 === void 0 ? void 0 : _v$onDisconnected6.call(v, _types.DisconnectReasonType.user_did_remove_from_server);
    });
  }
  onUserDidForbidByServer() {
    this._listeners.forEach(v => {
      var _v$onDisconnected7;
      (_v$onDisconnected7 = v.onDisconnected) === null || _v$onDisconnected7 === void 0 ? void 0 : _v$onDisconnected7.call(v, _types.DisconnectReasonType.user_did_forbid_by_server);
    });
  }
  onUserDidChangePassword() {
    this._listeners.forEach(v => {
      var _v$onDisconnected8;
      (_v$onDisconnected8 = v.onDisconnected) === null || _v$onDisconnected8 === void 0 ? void 0 : _v$onDisconnected8.call(v, _types.DisconnectReasonType.user_did_change_password);
    });
  }
  onUserDidLoginTooManyDevice() {
    this._listeners.forEach(v => {
      var _v$onDisconnected9;
      (_v$onDisconnected9 = v.onDisconnected) === null || _v$onDisconnected9 === void 0 ? void 0 : _v$onDisconnected9.call(v, _types.DisconnectReasonType.user_did_login_too_many_device);
    });
  }
  onUserKickedByOtherDevice() {
    this._listeners.forEach(v => {
      var _v$onDisconnected10;
      (_v$onDisconnected10 = v.onDisconnected) === null || _v$onDisconnected10 === void 0 ? void 0 : _v$onDisconnected10.call(v, _types.DisconnectReasonType.user_kicked_by_other_device);
    });
  }
  onUserAuthenticationFailed() {
    this._listeners.forEach(v => {
      var _v$onDisconnected11;
      (_v$onDisconnected11 = v.onDisconnected) === null || _v$onDisconnected11 === void 0 ? void 0 : _v$onDisconnected11.call(v, _types.DisconnectReasonType.user_authentication_failed);
    });
  }
...
exports.ChatServiceListenerImpl = ChatServiceListenerImpl;
