...
export const asyncTask = function (f) {
  try {
...
export const timeoutTask = function (timeout, f) {
...
export const queueTask = function (f) {
 ...
 */
export const callbackToAsync = function (f, cb) {
