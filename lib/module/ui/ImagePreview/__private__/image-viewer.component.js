...
import { Animated, I18nManager, Image, Text, TouchableHighlight, TouchableOpacity, TouchableWithoutFeedback, View } from 'react-native';
import styles from './image-viewer.style';
import { ImageViewerProps, ImageViewerState } from './image-viewer.type';
import { ImageZoom } from './image-zoom.component';
export class ImageViewer extends React.Component {
  static defaultProps = new ImageViewerProps();
  state = new ImageViewerState();
  ...
  loadImage(index) {
    ...
    Image.getSize((image === null || image === void 0 ? void 0 : image.url) ?? 'not found url', (width, height) => {
  ...
  handleResponderRelease = (() => {
    ...
    return function () {
      ...
      const isLeftMove = I18nManager.isRTL ? _this2.positionXNumber - _this2.standardPositionX < -(_this2.props.flipThreshold || 0) : _this2.positionXNumber - _this2.standardPositionX > (_this2.props.flipThreshold || 0);
      const isRightMove = I18nManager.isRTL ? _this2.positionXNumber - _this2.standardPositionX > (_this2.props.flipThreshold || 0) : _this2.positionXNumber - _this2.standardPositionX < -(_this2.props.flipThreshold || 0);
      if (vxRTL > 0.7) {
        // 上一张
  ...
  getContent() {
    ...
    const ImageElements = this.props.imageUrls.map((image, index) => {
      ...
      const Wrapper = _ref => {
        ...
        return /*#__PURE__*/React.createElement(ImageZoom, _extends({
      ...
      switch (imageInfo.status) {
        ...
        case 'success':
          ...
          return /*#__PURE__*/React.createElement(ImageZoom, {
            key: index,
    ...
    }, this.props.renderHeader(this.state.currentShowIndex), /*#__PURE__*/React.createElement(View, {
      style: this.styles.arrowLeftContainer
    }, /*#__PURE__*/React.createElement(TouchableWithoutFeedback, {
      onPress: this.goBack
    }, /*#__PURE__*/React.createElement(View, null, this.props.renderArrowLeft()))), /*#__PURE__*/React.createElement(View, {
      style: this.styles.arrowRightContainer
    }, /*#__PURE__*/React.createElement(TouchableWithoutFeedback, {
      onPress: this.goNext
    }, /*#__PURE__*/React.createElement(View, null, this.props.renderArrowRight()))), /*#__PURE__*/React.createElement(Animated.View, {
      style: {
        ...this.styles.moveBox,
        transform: [{
    ...
    }, ImageElements), this.props.renderIndicator((this.state.currentShowIndex || 0) + 1, this.props.imageUrls.length), this.props.imageUrls[this.state.currentShowIndex || 0] && this.props.imageUrls[this.state.currentShowIndex || 0].originSizeKb && this.props.imageUrls[this.state.currentShowIndex || 0].originUrl && /*#__PURE__*/React.createElement(View, {
      style: this.styles.watchOrigin
    }, /*#__PURE__*/React.createElement(TouchableOpacity, {
      style: this.styles.watchOriginTouchable
    }, /*#__PURE__*/React.createElement(Text, {
      style: this.styles.watchOriginText
    }, "\u67E5\u770B\u539F\u56FE(2M)"))), /*#__PURE__*/React.createElement(View, {
      style: [{
        bottom: 0,
        position: 'absolute',
        zIndex: 9
  ...
  getMenu() {
    ...
    }, this.props.menuContext.saveToLocal)), /*#__PURE__*/React.createElement(TouchableHighlight, {
      underlayColor: "#F2F2F2",
  ...
  render() {
    let childs = null;
    childs = /*#__PURE__*/React.createElement(View, null, this.getContent(), this.getMenu());
    return /*#__PURE__*/React.createElement(View, {
