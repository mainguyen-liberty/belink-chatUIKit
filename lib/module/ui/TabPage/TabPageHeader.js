...
import { gHeaderHeight, gIndicatorBorderRadius, gIndicatorHeight, gIndicatorWidth } from './TabPage.const';
import { useTabPageHeaderAnimation2 } from './TabPageHeader.hooks';
export function TabPageHeader(props) {
  const {
    propRef,
    onClicked,
    titles,
